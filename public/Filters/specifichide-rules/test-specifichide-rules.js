...
window.addEventListener('load', function () {
    ...
    QUnit.test('1. Test rule with specifichide modifier', function (assert) {
    ...
    QUnit.test('2. Test rule with specifichide modifier vs generic basic rule', function (assert) {
    ...
    QUnit.test('3. Test rule with specifichide modifier vs generic css rule', function (assert) {
