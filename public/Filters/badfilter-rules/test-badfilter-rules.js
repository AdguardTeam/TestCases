...
window.addEventListener('DOMContentLoaded', function () {
    ...
    const adgCheck = getComputedStyle(window.document.getElementById('subscribe-to-test-badfilter-rules-filter'), null).display === 'none';
    ...
    QUnit.test("Case 2: $badfilter exception rule test", function (assert) {
        const imageBlocked = getComputedStyle(document.querySelector("#case2 > img"), null).display === "none";
