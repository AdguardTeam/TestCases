...
<head>
    <meta charset="UTF-8">
    <title>Userscripts: Content security policy (CSP) tests - {{id}}</title>
    {{#policy.asMetaTag}}
...
<body class="container mt-5">
    ...
    <section class="mt-4">
        <a href="../userscripts-csp" class="btn btn-primary">Back to Test Cases</a>
    </section>
...
<head>
    <meta charset="UTF-8">
    <title>Userscripts: Content security policy (CSP) tests</title>
</head>
<body class="container mt-5">
    <h1 class="text-primary">Userscripts: Content security policy (CSP) tests</h1>

    <section class="mt-4">
       <a href="/Userscripts/cspTester/csp-tester.user.js" class="text-primary font-weight-bold">
           Install the test userscript
       </a>
    </section>
        ...
        <ul class="list-group mt-2">
            {{#cases}}
                <li class="list-group-item">
                    ...
                    <label for="case-{{id}}">
                        <a href="./userscripts-csp/{{id}}" class="text-primary font-weight-bold">{{id}}</a>
                        <p class="mb-0">
