...
(function () {
    ...
    const onclickDispatchEventOnAnchor = {
    ...
    const getOpenRefFromFreshIframe = {
        ...
        handleEvent() {
            ...
            const freshClick = freshFrame.contentWindow.HTMLElement.prototype.click;
    ...
    const executeInFreshIframeViaDocumentWrite = {
 ...
 */
    const chromePDFPopunder = {
        ...
        handleEvent(event) {
            ...
            /* eslint-disable-next-line no-restricted-globals */
            const popunder = open('about:blank', '_blank', this._smallWindowConfig);
